...
@WebServlet("/GetCorsiStudente")
public class GetCorsiStudente extends HttpServlet {
	private static final long serialVersionUID = 1L;
	private Connection connection = null;

	public GetCorsiStudente() {
		super();
	}
	...
	protected void doGet(HttpServletRequest request, HttpServletResponse response)
		...
		try {
			...
			response.sendError(HttpServletResponse.SC_BAD_GATEWAY, "Failure in studente's corsi's database extraction");
			return;
		}
